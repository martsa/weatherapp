    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                url1 ="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=462f445106adc1d21494341838c10019&units=metric";
                FindWeather(url1);
            }
        });

        Bundle bundle = getIntent().getExtras();
        String latitute=bundle.getString("latitute");
        String longitute= bundle.getString("longitute");
        url2="https://api.openweathermap.org/data/2.5/weather?lat="+latitute+"&lon="+longitute+"&appid=462f445106adc1d21494341838c10019&units=metric";
        FindWeather(url2);
        Log.e("javanweather",latitute);

    }

    public void FindWeather(String url1)
    {
      String  url =url1;
        //  String url ="http://api.openweathermap.org/data/2.5/forcast?q="+city+"appid=141491ac17ba77a6519fa724092d07a0&units=metric";
